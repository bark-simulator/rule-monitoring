...
const std::string& Label::get_label_str() const { return label_str_; }
int Label::get_agent_id() const { return agent_id_; }
bool Label::is_agent_specific() const { return is_agent_specific_; }
...
Label Label::make_alive() { return Label("alive"); }
}  // namespace ltl
